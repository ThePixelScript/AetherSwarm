...
from ares_swarm.core.models import UAVState, Role, StateSnapshot, TaskState
...
def test_e_egress_safety_regression():
    ...
    pos2 = (30.1, 0.0)
    for c in cmds:
        if c.uav_id == 'uav_1': pos1 = c.new_position_xy
        if c.uav_id == 'uav_2': pos2 = c.new_position_xy
